...
export async function GET(request, { params }) {
  console.info("Spoonacular nutrition request received.");
  ...
  try {
    ...
    const requestUrl = `${BASE_URL}/recipes/${id}/nutritionWidget.json?${apiParams}`;
    ...
    console.error('Error in Spoonacular nutrition route:', { errorMessage: error.message, errorStack: error.stack });
